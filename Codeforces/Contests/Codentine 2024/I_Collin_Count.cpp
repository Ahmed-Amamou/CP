...
pair<double, double> constructLine(pair<ll, ll> point1, pair<ll, ll> point2)
{
    double a = (double)(point1.second - point2.second) / (double)(point1.first - point2.first) ;
    double b = (double)point1.second - a * point2.first;
